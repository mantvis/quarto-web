...
Note that Quarto calls the multiplex server behind the scenes to provision an id and a secret for your presentation. If you want to provision your own id and secret you can do so at <https://reveal-multiplex.glitch.me/> (or using your custom hosted server URL) and provide them explicitly in YAML:
